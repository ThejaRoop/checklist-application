...
export class StudyService {
  ...
  getStudy(studyId : string) : any {
      console.log('Hello');
      return this.http.get(this.studyUrl + '/' + studyId).pipe(map(this.extractObserverData), catchError(this.handleError<Hero[]>('getHeroes', [])));
  }
  ...
  getStudyIds() {
    return this.http.get(this.studyIdsUrl).pipe(map(this.extractObserverData), catchError(this.handleError<Hero[]>('getHeroes', [])));
  }
