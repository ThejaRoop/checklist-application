var checkListData = {
    ...
    "Before initial FPP release": {
        ...
        data:[{
            "Create initial HQ-TOC, mark applicability":[['initialHqToc'],'T'],
    ...
    "Site COV" : {
        ...
        data:[{
            ...
            "Perform full QC/gap analysis, send list of outstanding docs to CRA before Sites COV": [['qcGapAnalysis'], 'C']
        }],
